  ...
  questions={[
    {
      ...
      choices: [
        {
          id: 'a',
          text: '「陽性対照と陰性対照」は、対照やサンプル条件を見なくても結果を解釈できる。',
        },
        {
          id: 'b',
          text: '実験系、試薬、検出方法、サンプル処理などが期待どおり働いていない可能性を考えます。',
        },
        {
          id: 'c',
          text: '「陽性対照と陰性対照」は、手法名だけで測定対象と限界まで完全に分かる。',
        },
        {
          id: 'd',
          text: '「陽性対照と陰性対照」は、陰性対照や陽性対照とは関係しない。',
        },
      ],
      answer: 'b',
      explanation:
    ...
    },
    {
      ...
      choices: [
        ...
        {
          id: 'c',
          text: '背景信号、非特異的反応、混入、条件設定の問題などを確認する必要があります。',
        },
        {
          id: 'd',
          text: '「陽性対照と陰性対照」は、陰性対照や陽性対照とは関係しない。',
