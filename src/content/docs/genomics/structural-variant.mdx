  ...
  questions={[
    {
      ...
      question: '構造多型の代表例を挙げてください。',
      choices: [
        {
          id: 'a',
          text: '「構造多型」は、ゲノム上の位置だけで機能や影響が完全に分かる。',
        },
        {
          id: 'b',
          text: '「構造多型」は、参照ゲノムやアノテーションを確認しなくても解釈できる。',
        },
        {
          id: 'c',
          text: '欠失、重複、逆位、転座などがあります。',
        },
        {
          id: 'd',
          text: '「構造多型」は、すべての細胞や個体で同じ意味を持つ。',
        },
      ],
      answer: 'c',
      explanation: '欠失、重複、逆位、転座などがあります。',
    },
    {
      id: 'structural-variant-q2',
      question: '構造多型の検出で手法を確認する理由を説明してください。',
      choices: [
        {
          id: 'a',
        ...
        {
          id: 'd',
          text: '手法によって検出しやすいサイズや種類、ブレークポイントの解像度が違うからです。',
        },
      ],
      answer: 'd',
      explanation:
        '手法によって検出しやすいサイズや種類、ブレークポイントの解像度が違うからです。',
    },
  ]}
/>
