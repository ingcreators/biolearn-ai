...
[Methods](/glossary/methods/)では、バリアント検出の条件、集団頻度のしきい値、使ったデータベースが説明されることがあります。[Results](/glossary/results/)や[Figure](/glossary/figure/)では、マンハッタンプロット、バリアント表、アリル頻度の比較として示されます。
