  ...
  questions={[
    {
      ...
      choices: [
        {
          id: 'a',
          text: '「SAM/BAM」は、メタデータや前処理を確認しなくても解釈できる。',
        },
        {
          id: 'b',
          text: '「SAM/BAM」は、図上の近さや色分けだけで生物学的結論を決められる。',
        },
        {
          id: 'c',
          text: '「SAM/BAM」は、データの品質やバッチ効果とは関係しない。',
        },
        {
          id: 'd',
          text: 'マッピング後のリードが参照配列のどこに、どのように対応したかを保存する形式です。',
        },
      ],
      answer: 'd',
      explanation:
    ...
    },
    {
      ...
      choices: [
        {
          id: 'a',
          text: 'SAMはテキスト形式、BAMは同じ情報を圧縮して扱うバイナリ形式です。',
        },
        {
          id: 'b',
    ...
    },
    {
      ...
      choices: [
        ...
        {
          id: 'b',
          text: '参照配列の版が違うと座標や注釈との対応がずれ、解釈を誤ることがあるからです。',
        },
        {
          id: 'c',
