  ...
  questions={[
    {
      ...
      choices: [
        ...
        {
          id: 'b',
          text: 'サンプルごとの総リード数、検出効率、技術的ばらつきなどがカウントに影響するため、比較しやすい尺度に整える必要があるからです。',
        },
        {
          id: 'c',
    ...
    },
    {
      ...
      choices: [
        ...
        {
          id: 'c',
          text: '生カウントは観測された数で、正規化後の値は比較しやすいように尺度を調整した値です。',
        },
        {
          id: 'd',
          text: '正規化方法や対数変換を確認しなくても、値の意味は常に同じである。',
    ...
    },
    {
      ...
      choices: [
        ...
        {
          id: 'd',
          text: '正規化方法、対数変換の有無、フィルタ条件、品質管理の結果、バッチ効果の扱いなどです。',
        },
      ],
      answer: 'd',
      explanation:
