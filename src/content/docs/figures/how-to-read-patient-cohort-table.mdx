  ...
  questions={[
    {
      ...
      question:
        '患者コホート表で、後続のFigureを見る前に確認したい項目を3つ挙げてください。',
      choices: [
        {
          id: 'a',
          text: '対象者数、群分け、年齢や性別などの背景、病期、欠測、追跡期間、除外基準などです。',
        },
        {
          id: 'b',
      ...
      answer: 'a',
      explanation:
        '対象者数、群分け、年齢や性別などの背景、病期、欠測、追跡期間、除外基準などです。',
    },
    {
      id: 'how-to-read-patient-cohort-table-q2',
      question:
        'Kaplan-Meier曲線やROC曲線を読む前に、患者コホート表を確認する理由を説明してください。',
      choices: [
        {
          id: 'a',
        ...
        {
          id: 'b',
          text: '群の人数、背景、欠測、追跡期間などがFigureの見え方や解釈に影響するためです。',
        },
        {
          id: 'c',
      ...
      answer: 'b',
      explanation:
        '群の人数、背景、欠測、追跡期間などがFigureの見え方や解釈に影響するためです。',
    },
  ]}
/>
